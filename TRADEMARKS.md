...
applies to the extent those identifiers are protected; it does not claim that a
particular mark is registered.
...
- identify an unmodified copy accurately, without implying that you operate the
...
`Trademark request`, including the proposed name, artwork, distribution channel,
and a mock-up of the use.
