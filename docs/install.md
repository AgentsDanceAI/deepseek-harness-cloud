...
Release `0.2.2` has two equivalent, version-locked installers. Both default to
...
Release `0.2.2` uses the exact registry coordinates
`@agentsdanceai/dsh-cloud@0.2.2` and `dsh-cloud==0.2.2`. Keep the explicit version
