...
Release `0.2.1` has two equivalent, version-locked installers. Both default to
...
Release `0.2.1` uses the exact registry coordinates
`@agentsdanceai/dsh-cloud@0.2.1` and `dsh-cloud==0.2.1`. Keep the explicit version
