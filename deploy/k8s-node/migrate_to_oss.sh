...
# no_check_bucket: 只限桶内的密钥查不了桶, 不跳过 rclone 会去建桶撞 409 (与 workbackend 里的 Secret 一致)
export RCLONE_CONFIG_OSS_TYPE=s3 RCLONE_CONFIG_OSS_PROVIDER=Alibaba RCLONE_CONFIG_OSS_NO_CHECK_BUCKET=true
